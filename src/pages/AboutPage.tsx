  ...
  return (
    <div className="space-y-16 py-6 max-w-5xl mx-auto">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <h1 className="font-heading font-black text-4xl sm:text-5xl text-white">AMATORA Futbol Boshqaruv Platformasi</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="glass-card p-8 space-y-4">
          ...
          <h2 className="font-heading font-bold text-2xl text-white">Bizning Maqsadimiz</h2>
        ...
        <div className="glass-card p-8 space-y-4">
          ...
          <h2 className="font-heading font-bold text-2xl text-white">Infratuzilma Standarti</h2>
          <p className="text-xs text-slate-400 leading-relaxed">
      ...
      <div className="glass-card p-8 lg:p-10 space-y-6">
        <div className="flex items-center gap-3 border-b border-white/10 pb-4">
          ...
          <div>
            <h3 className="font-heading font-bold text-xl text-white">Tizim Arxitekturasi va Texnik Spetsifikatsiyasi</h3>
