...
export const translations = {
  uz: {
    ...
    'apps.score.badge': 'Windows • v2.5.0',
    ...
    'apps.obs.badge': 'OBS Studio • v3.7.5',
    ...
    'apps.obs.btn': 'OBS Controller Yuklab Olish (.exe)',
    'apps.obs.sub': 'Windows 10 / 11 (64-bit) • 2.7 MB',

    'apps.guide.title': 'O\'rnatish Qo\'llanmasi',
    'apps.guide.step1.title': 'O\'rnatish Faylini Yuklang',
    'apps.guide.step1.desc': 'Kerakli dastur (Scoreboard yoki OBS Controller) Setup (.exe) faylini kompyuteringizga yuklab oling.',
    'apps.guide.step2.title': 'O\'rnatishni Boshlang',
    'apps.guide.step2.desc': 'Yuklangan Setup.exe faylini oching va Install tugmasini bosing.',
  ...
  ru: {
    ...
    'apps.obs.btn': 'Скачать OBS Controller (.exe)',
    'apps.obs.sub': 'Windows 10 / 11 (64-bit) • 2.7 MB',

    'apps.guide.title': 'Инструкция по Установке',
    'apps.guide.step1.title': 'Скачайте Установочный Файл',
    'apps.guide.step1.desc': 'Скачайте установочный файл Setup (.exe) нужной программы (Scoreboard или OBS Controller) на ваш компьютер.',
    'apps.guide.step2.title': 'Запустите Установку',
    'apps.guide.step2.desc': 'Запустите скачанный файл Setup.exe и нажмите кнопку "Install".',
  ...
  en: {
    ...
    'apps.obs.btn': 'Download OBS Controller (.exe)',
    'apps.obs.sub': 'Windows 10 / 11 (64-bit) • 2.7 MB',

    'apps.guide.title': 'Installation Guide',
    'apps.guide.step1.title': 'Download Installer File',
    'apps.guide.step1.desc': 'Download the software Setup (.exe) installer file (Scoreboard or OBS Controller) to your computer.',
    'apps.guide.step2.title': 'Run Installation',
    'apps.guide.step2.desc': 'Run the downloaded Setup.exe installer and click "Install".',
